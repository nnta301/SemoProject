...
export { default as MaintenancePage } from './admin/MaintenancePage'
...
export { default as ChargingPage } from './admin/ChargingPage'
export { default as GeofencePage } from './admin/GeofencePage'